		...
		<div class="container-fluid">	
			<div class="navbar-header">
				<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#collapse" aria-expanded="false">
					<span class="sr-only"> navigacion</span>
			...
			<ul class="nav navbar-nav navbar-right">
						...
						<div class="panel panel-success">
							<div class="panel-heading">
								<div class="row">
									...
									<div class="col-md-3 col-xs-3">Imagen de Producto</div>
									<div class="col-md-3 col-xs-3">Nombre de Producto</div>
				...
				<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"></span> <?php echo "Hola, ".$_SESSION["name"]; ?></a>
					<ul class="dropdown-menu">
						<li><a href="cart.php" style="text-decoration:none; color:black;"><span class="glyphicon glyphicon-shopping-cart"> Carrito</a></li>
						<li class="divider"></li>
						<li><a href="customer_order.php" style="text-decoration:none; color:black;">Ordenes</a></li>
						<li class="divider"></li>
