			...
			<div class="col-md-8">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<h1>Detalles de Orden del Cliente</h1>
						<hr/>
						<?php
							include_once("db.php");
								...
								while ($row=mysqli_fetch_array($query)) {
									?>
										<div class="row">
											...
											<div class="col-md-6">
												<table>
													<tr><td>Nombre de Producto</td><td><b><?php echo $row["product_title"]; ?></b> </td></tr>
													...
													<tr><td>ID de Transaccion</td><td><b><?php echo $row["trx_id"]; ?></b></td></tr>
												</table>
											</div>
										</div>
									<?php
